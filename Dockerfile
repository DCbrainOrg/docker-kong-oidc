...
RUN set -ex \
    ...
    && curl -sL https://raw.githubusercontent.com/DCbrainOrg/kong-oidc/v${KONG_PLUGIN_OIDC_VER}/kong-oidc-${KONG_PLUGIN_OIDC_VER}.rockspec | tee kong-oidc-${KONG_PLUGIN_OIDC_VER}.rockspec | \
    ...
    && cat kong-oidc-${KONG_PLUGIN_OIDC_VER}.rockspec \
